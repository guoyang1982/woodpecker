...
define(function(){
    ...
    ApplicationEdit.prototype = {
        ...
        initEvents: function () {
            var that = this;
            // 保存
            $("#div_application_edit").off("click.application_save_edit").on("click.application_save_edit", "#btn_application_save_edit", function () {
                that.btnSave();
            });
            // 返回
            $("#div_application_edit").off("click.application_back_edit").on("click.application_back_edit", "#btn_application_back_edit", function () {
                that.btnBack();
            });
        ...
        loadContent: function () {
            ...
            var url = "/woodpecker/application/queryApp/" + appName;
            var params = {};
            var that = this;
        ...
        btnSave: function () {
            var that = this;
            $("#btn_application_save_edit").attr("disabled", true);
            // 保存请求
            $.ajax({
                url: "/woodpecker/application/updateAppInfo",
                type: "post",
