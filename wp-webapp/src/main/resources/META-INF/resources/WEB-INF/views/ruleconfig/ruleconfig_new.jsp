    ...
    <div id="contentList" class="row-fluid">
        ...
        <form id="form_ruleconfig" action="#" class="form-horizontal">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" name="ruleName" class="span6 m-wrap" value="" />
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <textarea name="ruleDesc" class="span8 m-wrap" rows="10"></textarea>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <textarea name="ruleConfig" class="span8 m-wrap" rows="10">${rule}</textarea>
                </div>
            </div>
            ...
            <div class="form-actions">
                ...
                <button id="btn_ruleconfig_save_new" type="button" class="btn green">保存</button>
                <button id="btn_ruleconfig_back_new" type="button" class="btn">返回</button>
            </div>
        </form>
        <!-- END FORM-->
    </div>
