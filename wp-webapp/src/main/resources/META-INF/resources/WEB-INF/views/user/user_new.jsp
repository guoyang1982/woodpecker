    ...
    <div id="contentList" class="row-fluid">
        ...
        <form id="form_user" action="#" class="form-horizontal">
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" name="loginName" class="span6 m-wrap" value="" />
                </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" name="userRole" class="span6 m-wrap" value=""/> <a><font color="red">默认是普通用户</font></a>
                </div>
            </div>
            <div class="form-actions">
                <button id="btn_user_save_new" type="button" class="btn green">保存</button>
                <button id="btn_user_back_new" type="button" class="btn">返回</button>
            </div>
        </form>
        <!-- END FORM-->
    </div>
