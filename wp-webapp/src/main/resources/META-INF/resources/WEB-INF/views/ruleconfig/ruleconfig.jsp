...
<head>
    ...
    <script type="text/javascript">
        jQuery(function () {
            ...
            require(['ruleconfig/ruleconfig'], function (ruleconfig) {
                var ruleconfig = new ruleconfig({
                    host: "${ctx}"
                });
                ruleconfig.setOptions({userName:"${username}"});
                ruleconfig.show();
            });
...
<div class="container-fluid">
    ...
    <div id="contentList" class="row-fluid">
        <div id="content_ruleconfig" data-sign="content" class="span12">
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption"><i class="icon-reorder"></i>规则配置 </div>
                </div>
                <div class="portlet-body">
                    <div class="clearfix">
                        <div class="btn-group">
                            <button id="btn_ruleconfig_new" class="btn green">
                                新增 <i class="icon-plus"></i>
                            </button>
                        </div>
                    </div>
                    <!-- <div id="form_ruleconfig_search" class="form-inline">
                        <input type="text" name="search_ruleconfig_key" class="span2" placeholder="源分类">
                        <button id="btn_ruleconfig_search" type="button" class="btn blue">搜索</button>
                    </div>  -->
                    <table id="table_ruleconfig" class="table table-striped table-bordered table-hover">
                        <thead>
                        </thead>
                        <tbody>
                        </tbody>
        ...
        <!-- 模板编辑 -->
        <div id="content_ruleconfig_edit" data-sign="content" class="span12" style="margin-left: 0px;">
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption"><i class="icon-list-alt"></i>配置详细信息</div>
                </div>
                <div id="div_ruleconfig_edit" class="portlet-body form" style="min-height: 600px;">
                </div>
            </div>
        </div>
        <!-- 模板编辑结束 -->
